...
function setLight() {
  ...
  document.documentElement.setAttribute("name-theme","light");
  document.documentElement.setAttribute("bar-theme","light");
  document.documentElement.setAttribute("btn-theme","light");
  document.documentElement.setAttribute("ft-color","light");
  document.documentElement.setAttribute("ring-color","light");
  document.documentElement.setAttribute("send-btn","light");
  ...
  document.documentElement.setAttribute("vign","light");
...
function setDark() {
  ...
  document.documentElement.setAttribute("name-theme","dark");
  document.documentElement.setAttribute("bar-theme","dark");
  document.documentElement.setAttribute("btn-theme","dark");
  document.documentElement.setAttribute("ft-color","dark");
  document.documentElement.setAttribute("ring-color","dark");
  ...
  document.documentElement.setAttribute("vign","dark");
